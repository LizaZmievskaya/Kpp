...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li id="current"><a href="dolzhnost.php">Должности</a></li>
            ...
            <div class="table-responsive">
                <table class="table"  style="text-align: center;">
                    <?php for ($i = 0; $i < count($rows); $i++) {?>
                        <tr data-id="<?= $rows[$i]['id']?>" data-dol="<?= $rows[$i]['dolzhnost']?>">
            ...
            <form method="post">
                <div class="modal-body">
                    <div class="form-horizontal">
                        <input name="dol" type="text" class="form-control" id="inputDol" placeholder="Должность">
                    </div>
                </div>
...
<script src="../js/actions_dol.js"></script>
</body>
</html>